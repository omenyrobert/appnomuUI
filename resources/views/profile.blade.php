                ...
                <div class="card-body">
                  <form method="POST" action="/editProfile">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">N.I.N <strong>({{'nin'}} )</strong></label>
                          <input type="text" name="NIN" class="form-control">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Card No. <strong>({{'card number'}})</strong>  </label>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          <label class="bmd-label-floating">Address <strong>(  {{'address'}} )</strong></label>
            ...
            <div class="col-md-4">
              <div class="card card-profile">
                ...
                <div class="card-body">
                    ...
                    ?>
                  <h6 class="card-category text-gray">{{'user_id'}}</h6>
                  <h4 class="card-title">{{'user name'}}</h4>
                  <h4 class="card-title">{{'telephone'}} <span class="badge ">{{ ''}}</span> </h4>
