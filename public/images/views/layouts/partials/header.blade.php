<header class="topbar">
    ...
    <input type="text" placeholder="search..." class="form-control bg-white" style="width: 70%; border: #ffa500;"><div class="form-control" style="background-color: #ffa500; width: 40px;"><img src="search.svg"/></div>
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item dropdown">
                ...
                >
                  <img src="bell.svg" style="margin-top: -42px;">
              ...
              <li class="nav-item dropdown">
                ...
                >
                  <img src="chat.svg" style="margin-top: -42px;">
                  <div class="notify" style="margin-top: -20px;">
                    <span class="heartbit"></span> <span class="point"></span>
                  </div>
                </a>
              ...
              <li class="nav-item dropdown">
                <a
                  ...
                  style="background-color: #ffa500; border-radius: 5px; height: 35px; margin-top: 20px; margin-left: 8px;"
                >
                  <img src="gift.svg" style="margin-top: -42px;">
                  <div class="notify" style="margin-top: -20px;">
                    <span class="heartbit"></span> <span class="point"></span>
                  </div>
                </a>
              ...
              <li class="nav-item dropdown">
                <a
                  ...
                  style="background-color: #ffa500; border-radius: 5px; height: 35px; margin-top: 20px; margin-left: 8px;"
                >
                  <img src="envelope.svg" style="margin-top: -42px;">
                  <div class="notify" style="margin-top: -20px;">
                    <span class="heartbit"></span> <span class="point"></span>
                  </div>
                </a>
