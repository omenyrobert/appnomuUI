<?php
use App\Jobs\FlutterwaveWebhookResponse;
return [
    'configs' => [
        [
            /*
             ...
             */
            'signing_secret' => env('FLW_WEBHOOK_CLIENT_SECRET'),
             ...
             */
            'process_webhook_job' => FlutterwaveWebhookResponse::class,
        ],
        [
            /*
             * This package supports multiple webhook receiving endpoints. If you only have
             ...
             * is used to verify that the payload has not been tampered with.
             */
            'signing_secret' => env('RELOADLY_WEBHOOK_CLIENT_SECRET'),
